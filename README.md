...
- 📧 **分组通知**: 邮件分组管理系统，支持多接收者和独立配置
- ⚙️ **灵活配置**: 支持多币种、独立阈值设置、自定义触发时间
- 📊 **实时进度**: 抓取状态实时追踪，前端进度条显示
- 🎯 **模块化前端**: 前端代码模块化重构，提升可维护性
...
Windows和macOS启动脚本现在都支持自动重启功能：

**功能特点**：
- 🚀 **自动恢复**：应用崩溃或停止后，等待3秒自动重启
- 🖥️ **清屏显示**：每次重启时清屏，提供更清晰的输出
- 📊 **状态监控**：显示应用退出代码，便于调试和监控
- ⏹️ **手动停止**：使用 `Ctrl+C` 可以停止自动重启循环
...
```
===================================
  CoinGlass Monitor Starting...
===================================
  Press Ctrl+C to stop auto-restart
===================================
```
